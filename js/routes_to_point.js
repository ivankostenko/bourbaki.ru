ymaps.ready(function () {
    ...
    var targetCoords = [55.759755068986976,37.65133099999999],
    ...
    // Метка для конечной точки маршрута.
        targetPoint = new ymaps.Placemark(targetCoords, { iconContent: 'Ателье Бурбаки | Лялин пер. 8с1' }, { preset: 'islands#redStretchyIcon', iconColor: '#ff0000' }),
